...
import ".."
Rectangle {
 id: root; property string text: ""; property string help:""; property bool active: false; property bool available:true; property color accent: ScopeTheme.accent; signal clicked()
